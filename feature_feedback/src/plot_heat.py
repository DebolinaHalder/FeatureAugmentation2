...
pokek_n = [0.00255578,0.0043007489394781,0.01263007489394781,0.020753262,0.028753262,0.034224096]
...
pokek_n_rndm = [0.0055578,0.0103007489394781,0.01263007489394781,0.021753262,0.030753262,0.034224096]
...
german_adv2 = [-0.022147911,-0.0156162, -0.0011156162,0.0231117289,0.029117289,0.075492697]
bail_adv2 = [0.0090920554,0.0291582, 0.0311582,0.032638199, 0.04038199, 0.077326037]
credit_adv2 = [-0.00442332,-0.00765081, 0.00065081,0.00191919,0.007051919, 0.038283324]
nba_adv2 = [-0.0857652,-0.000362089, 0.00062089,0.0102771458, 0.010771458,0.016993261]
pokek_z_adv2 = [-0.03674055,0.0097382,0.01827382,0.02504957, 0.03814957,0.034224096]
pokek_n_adv2 = [0.0035578,0.00803007489394781,0.01063007489394781,0.02153262,0.029753262,0.034224096]


german_bfts_adv2 = [0.00808620710654506,0.024226434402719,0.064226434402719,0.07314791053658207,0.07814791053658207,0.075492697]
bail_bfts_adv2 = [0.1266963499816,0.13021541, 0.140021541,0.109747797,0.0806398239788153, 0.077326037]
credit_bfts_adv2 = [0.0732653663397614,0.0673594152717873,0.0623594152717873,0.0523594152717873,0.0443442446149904, 0.038283324]
nba_bfts_adv2 = [0.0632824310525589,0.0532824310525589,0.03732824310525589,0.0182824310525589,0.0149036638638652,0.016993261]
pokek_z_bfts_adv2 = [0.0201674055,0.02327382,0.02527382,0.035957, 0.0384957,0.034224096]
pokek_n_bfts_adv2 = [0.02155578,0.0258007489394781,0.02613007489394781,0.036153262,0.040753262,0.034224096]


#%%
matrix = [german,bail,credit,pokek_z,nba,pokek_n]
matrix_avd2 = [german_adv2,bail_adv2,credit_adv2,pokek_z_adv2,nba_adv2,pokek_n_adv2]
matrix_bfts = [german_bfts,bail_bfts,credit_bfts,pokek_z_bfts,(nba_bfts),pokek_n_bfts]
matrix_bfts_adv2 = [german_bfts_adv2,bail_bfts_adv2,credit_bfts_adv2,pokek_z_bfts_adv2,(nba_bfts_adv2),pokek_n_bfts_adv2]
...
fig, ax = plt.subplots(2,3,figsize = (38,20),sharex=True)
...
sns.heatmap(matrix_rndm, cmap=rdgn, center=0.00, fmt ='.0%', 
            linewidths=1.3, linecolor='black', cbar=True, ax=ax[0][0],cbar_ax=cbar_ax,vmin=-0.25, vmax=0.25)
sns.heatmap(matrix_rndm_bfts, cmap=rdgn, center=0.00, fmt ='.0%', 
            linewidths=1.3, linecolor='black', cbar=False, ax=ax[1][0],cbar_ax=cbar_ax,vmin=-0.25, vmax=0.25)
sns.heatmap(matrix_avd2, cmap=rdgn, center=0.00, fmt ='.0%', 
            linewidths=1.3, linecolor='black', cbar=True, ax=ax[0][1],cbar_ax=cbar_ax,vmin=-0.25, vmax=0.25)
sns.heatmap(matrix_bfts_adv2, cmap=rdgn, center=0.00, fmt ='.0%', 
            linewidths=1.3, linecolor='black', cbar=False, ax=ax[1][1],cbar_ax=cbar_ax,vmin=-0.25, vmax=0.25)
sns.heatmap(matrix, cmap=rdgn, center=0.00, fmt ='.0%', 
            linewidths=1.3, linecolor='black', cbar=True, ax=ax[0][2],cbar_ax=cbar_ax,vmin=-0.25, vmax=0.25)
sns.heatmap(matrix_bfts, cmap=rdgn, center=0.00, fmt ='.0%', 
            linewidths=1.3, linecolor='black', cbar=False, ax=ax[1][2],cbar_ax=cbar_ax,vmin=-0.25, vmax=0.25)
ax[0][0].set_yticks([.5, 1.5, 2.5,3.5,4.5,5.5])
ax[1][0].set_yticks([.5, 1.5, 2.5,3.5,4.5,5.5])
ax[1][1].set_xticks([.5, 1.5, 2.5,3.5,4.5,5.5])
ax[1][0].set_xticks([.5, 1.5, 2.5,3.5,4.5,5.5])
ax[1][1].set_xticks([.5, 1.5, 2.5,3.5,4.5,5.5])

ax[1][0].set_xticklabels(ranges,rotation=45, ha="right", rotation_mode="anchor")
ax[1][1].set_xticklabels(ranges,rotation=45, ha="right", rotation_mode="anchor")
ax[1][2].set_xticklabels(ranges,rotation=45, ha="right", rotation_mode="anchor")

ax[0][0].set_yticklabels(datasets,rotation=45, ha="right", rotation_mode="anchor")
ax[1][0].set_yticklabels(datasets,rotation=45, ha="right", rotation_mode="anchor")
ax[0][1].set_yticks([])
ax[0][2].set_yticks([])
ax[1][1].set_yticks([])
ax[1][2].set_yticks([])
fig.text(0.5, -0.01, '% of available sensitive information', ha='center')
ax[0][2].set_title(r"$\mathbf{C1.}$ Ind, Adv (Degree)", pad=15)
ax[0][1].set_title(r"$\mathbf{B1.}$ Ind, Adv (Targeted)", pad=15)
ax[0][0].set_title(r"$\mathbf{A1.}$ Ind, MCAR", pad=15)

ax[1][2].set_title(r"$\mathbf{C2.}$ BFtS, Adv (Degree)", pad=15)
ax[1][1].set_title(r"$\mathbf{B2.}$ BFtS, Adv (Targeted)", pad=15)
ax[1][0].set_title(r"$\mathbf{A2.}$ BFtS, MCAR", pad=15)

fig.text(0.55, 0.95,' Bias in data represented as correlation between node labels and sensitive attribute ',ha = 'center')
plt.savefig("heatmap_correlation2.pdf",bbox_inches='tight')
#%%
sns.set(font_scale=4)

fig, ax = plt.subplots(1,4,figsize = (36,10),sharex=True)
cbar_ax = fig.add_axes([0.95, 0.15, 0.02, 0.7])
rdgn = sns.diverging_palette(h_neg=130, h_pos=10, s=99, l=55, sep=10, as_cmap=True)
sns.heatmap(matrix_bfts, cmap=rdgn, center=0.00, fmt ='.0%', 
